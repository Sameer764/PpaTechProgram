      ...
      <div className='banner-sub-container'>
        <div className="banner-left-text">
          ...
          <div className="banner-feature">
            <img src="./src/assets/img/banner-section-img/banner-feature.png" alt="banner-feature" />
          </div>
          <button className='apply-now-btn'>Apply Now</button>
        </div>
        <div className="banner-right-image">
          <img src="./src/assets/img/banner-section-img/banner-img.png" alt="banner-img"/>
        </div>
      </div>
    </div>
  )
